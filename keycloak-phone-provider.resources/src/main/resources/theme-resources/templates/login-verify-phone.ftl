...
<@layout.registrationLayout displayInfo=true displayWide=false; section>
    ...
    <#elseif section = "form">
        ...
        <div id="kc-form">
          <div id="kc-form-wrapper">
            <form id="kc-form-login" action="${url.loginAction}" method="post">
              <div class="${properties.kcFormGroupClass!} row">
                ...
                <div class="col-xs-8" style="padding: 0 5px 0 0">
                  <input tabindex="1" id="phoneNumber" class="${properties.kcInputClass!}"
                         name="phoneNumber" type="tel" <#if !(form.phoneNumber?has_content)>autofocus</#if>
              ...
              <div class="${properties.kcFormGroupClass!} row">
                <label for="smsCode" class="${properties.kcLabelClass!}">${msg("verificationCode")}</label>
                <input tabindex="3" id="smsCode" class="${properties.kcInputClass!}" name="smsCode"
                       type="text" <#if form.phoneNumber?has_content>autofocus</#if>
                       autocomplete="off"/>
              </div>
      ...
      <script type="text/javascript">
          ...
          <#if form.phoneNumber?has_content>
          req('${form.phoneNumber}');
          </#if>
      </script>
    <#elseif section = "info">
        ${msg("verifyPhoneNumberInfo")}
    </#if>
